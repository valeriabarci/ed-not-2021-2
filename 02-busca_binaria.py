...
comps = 0   # Declarandp uma variável global
...
def busca_binaria(lista, valor_busca):
    ...
    while ini <= fim:
        ...
        # 1º caso: lista[meio] é igual o valor_busca
...
hora_ini=time()
print(f"Posição de VALERIA: {busca_binaria(nomes, 'VALERIA')}, {comps} comparações")
hora_fim = time()
print(f"Tempo gasto procurando VALÉRIA: {(hora_fim - hora_ini) * 1000}ms")
